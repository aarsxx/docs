...
```bash
curl -X POST "http://localhost:3000/api/trpc/compose.create" \
  -d '{
  "name": "string",
  "description": "string",
  "projectId": "string",
...
```js
fetch("http://localhost:3000/api/trpc/compose.create", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/compose.one?composeId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/compose.one?composeId=string", {
  method: "GET"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/compose.update" \
  -d '{
  "composeId": "string",
  "name": "string",
  "appName": "string",
...
```js
fetch("http://localhost:3000/api/trpc/compose.update", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/compose.delete" \
  -d '{
  "composeId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/compose.delete", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/compose.cleanQueues" \
  -d '{
  "composeId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/compose.cleanQueues", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/compose.allServices?composeId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/compose.allServices?composeId=string", {
  method: "GET"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/compose.randomizeCompose" \
  -d '{
  "composeId": "string",
  "prefix": "string"
}'
...
```js
fetch("http://localhost:3000/api/trpc/compose.randomizeCompose", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/compose.deploy" \
  -d '{
  "composeId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/compose.deploy", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/compose.redeploy" \
  -d '{
  "composeId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/compose.redeploy", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/compose.stop" \
  -d '{
  "composeId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/compose.stop", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/compose.getDefaultCommand?composeId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/compose.getDefaultCommand?composeId=string", {
  method: "GET"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/compose.generateSSHKey" \
  -d '{
  "composeId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/compose.generateSSHKey", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/compose.refreshToken" \
  -d '{
  "composeId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/compose.refreshToken", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/compose.removeSSHKey" \
  -d '{
  "composeId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/compose.removeSSHKey", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/compose.deployTemplate" \
  -d '{
  "projectId": "string",
  "id": "string"
}'
...
```js
fetch("http://localhost:3000/api/trpc/compose.deployTemplate", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/compose.templates"
```
...
```js
fetch("http://localhost:3000/api/trpc/compose.templates", {
  method: "GET"
});
```
