...
```bash
curl -X POST "http://localhost:3000/api/trpc/mysql.create" \
  -d '{
  "name": "string",
  "appName": "string",
  "dockerImage": "mysql:8",
...
```js
fetch("http://localhost:3000/api/trpc/mysql.create", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/mysql.one?mysqlId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/mysql.one?mysqlId=string", {
  method: "GET"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mysql.start" \
  -d '{
  "mysqlId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/mysql.start", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mysql.stop" \
  -d '{
  "mysqlId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/mysql.stop", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mysql.saveExternalPort" \
  -d '{
  "mysqlId": "string",
  "externalPort": 0
}'
...
```js
fetch("http://localhost:3000/api/trpc/mysql.saveExternalPort", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mysql.deploy" \
  -d '{
  "mysqlId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/mysql.deploy", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mysql.changeStatus" \
  -d '{
  "mysqlId": "string",
...
```js
fetch("http://localhost:3000/api/trpc/mysql.changeStatus", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mysql.reload" \
  -d '{
  "mysqlId": "string",
  "appName": "string"
}'
...
```js
fetch("http://localhost:3000/api/trpc/mysql.reload", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mysql.remove" \
  -d '{
  "mysqlId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/mysql.remove", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mysql.saveEnvironment" \
  -d '{
  "mysqlId": "string",
  "env": "string"
}'
...
```js
fetch("http://localhost:3000/api/trpc/mysql.saveEnvironment", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mysql.update" \
  -d '{
  "mysqlId": "string",
  "name": "string",
  "appName": "string",
...
```js
fetch("http://localhost:3000/api/trpc/mysql.update", {
  method: "POST"
});
```
