...
```bash
curl -X GET "http://localhost:3000/api/trpc/user.all"
```
...
```js
fetch("http://localhost:3000/api/trpc/user.all", {
  method: "GET"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/user.byAuthId?authId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/user.byAuthId?authId=string", {
  method: "GET"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/user.byUserId?userId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/user.byUserId?userId=string", {
  method: "GET"
});
```
