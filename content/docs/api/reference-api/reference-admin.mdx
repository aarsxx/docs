...
```bash
curl -X GET "http://localhost:3000/api/trpc/admin.one"
```
...
```js
fetch("http://localhost:3000/api/trpc/admin.one", {
  method: "GET"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/admin.createUserInvitation" \
  -d '{
...
```js
fetch("http://localhost:3000/api/trpc/admin.createUserInvitation", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/admin.removeUser" \
  -d '{
  "authId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/admin.removeUser", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/admin.getUserByToken?token=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/admin.getUserByToken?token=string", {
  method: "GET"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/admin.assignPermissions" \
  -d '{
  "userId": "string",
...
```js
fetch("http://localhost:3000/api/trpc/admin.assignPermissions", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/admin.cleanGithubApp"
```
...
```js
fetch("http://localhost:3000/api/trpc/admin.cleanGithubApp", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/admin.getRepositories"
```
...
```js
fetch("http://localhost:3000/api/trpc/admin.getRepositories", {
  method: "GET"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/admin.getBranches?repo=string&owner=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/admin.getBranches?repo=string&owner=string", {
  method: "GET"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/admin.haveGithubConfigured"
```
...
```js
fetch("http://localhost:3000/api/trpc/admin.haveGithubConfigured", {
  method: "GET"
});
```
