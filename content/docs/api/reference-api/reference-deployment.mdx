...
```bash
curl -X GET "http://localhost:3000/api/trpc/deployment.all?applicationId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/deployment.all?applicationId=string", {
  method: "GET"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/deployment.allByCompose?composeId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/deployment.allByCompose?composeId=string", {
  method: "GET"
});
```
