...
```bash
curl -X GET "http://localhost:3000/api/trpc/docker.getContainers"
```
...
```js
fetch("http://localhost:3000/api/trpc/docker.getContainers", {
  method: "GET"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/docker.getConfig?containerId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/docker.getConfig?containerId=string", {
  method: "GET"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/docker.getContainersByAppNameMatch?appName=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/docker.getContainersByAppNameMatch?appName=string", {
  method: "GET"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/docker.getContainersByAppLabel?appName=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/docker.getContainersByAppLabel?appName=string", {
  method: "GET"
});
```
