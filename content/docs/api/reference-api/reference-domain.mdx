...
```bash
curl -X POST "http://localhost:3000/api/trpc/domain.create" \
  -d '{
  "host": "string",
  "path": "string",
  "port": 0,
...
```js
fetch("http://localhost:3000/api/trpc/domain.create", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/domain.byApplicationId?applicationId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/domain.byApplicationId?applicationId=string", {
  method: "GET"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/domain.update" \
  -d '{
  "domainId": "string",
  "host": "string",
  "path": "string",
...
```js
fetch("http://localhost:3000/api/trpc/domain.update", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/domain.one?domainId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/domain.one?domainId=string", {
  method: "GET"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/domain.delete" \
  -d '{
  "domainId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/domain.delete", {
  method: "POST"
});
```
