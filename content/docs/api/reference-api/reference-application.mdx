...
```js
fetch("http://localhost:3000/api/trpc/application.create", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/application.one?applicationId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/application.one?applicationId=string", {
  method: "GET"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/application.reload" \
  -d '{
  "appName": "string",
...
```js
fetch("http://localhost:3000/api/trpc/application.reload", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/application.delete" \
  -d '{
  "applicationId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/application.delete", {
  method: "POST"
});
```
...
```js
fetch("http://localhost:3000/api/trpc/application.stop", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/application.start" \
  -d '{
  "applicationId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/application.start", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/application.redeploy" \
  -d '{
  "applicationId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/application.redeploy", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/application.saveEnvironment" \
  -d '{
  "applicationId": "string",
  "env": "string"
}'
...
```js
fetch("http://localhost:3000/api/trpc/application.saveEnvironment", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/application.saveBuildType" \
  -d '{
  "applicationId": "string",
...
```js
fetch("http://localhost:3000/api/trpc/application.saveBuildType", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/application.saveGithubProvider" \
  -d '{
  "applicationId": "string",
  "repository": "string",
  "branch": "string",
...
```js
fetch("http://localhost:3000/api/trpc/application.saveGithubProvider", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/application.saveDockerProvider" \
  -d '{
  "dockerImage": "string",
  "applicationId": "string",
  "username": "string",
...
```js
fetch("http://localhost:3000/api/trpc/application.saveDockerProvider", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/application.saveGitProdiver" \
  -d '{
...
```js
fetch("http://localhost:3000/api/trpc/application.saveGitProdiver", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/application.generateSSHKey" \
  -d '{
  "applicationId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/application.generateSSHKey", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/application.removeSSHKey" \
  -d '{
  "applicationId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/application.removeSSHKey", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/application.markRunning" \
  -d '{
  "applicationId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/application.markRunning", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/application.update" \
  -d '{
  "applicationId": "string",
  "name": "string",
  "appName": "string",
...
```js
fetch("http://localhost:3000/api/trpc/application.update", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/application.refreshToken" \
  -d '{
  "applicationId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/application.refreshToken", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/application.deploy" \
  -d '{
  "applicationId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/application.deploy", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/application.cleanQueues" \
  -d '{
  "applicationId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/application.cleanQueues", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/application.readTraefikConfig?applicationId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/application.readTraefikConfig?applicationId=string", {
  method: "GET"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/application.updateTraefikConfig" \
  -d '{
  "applicationId": "string",
...
```js
fetch("http://localhost:3000/api/trpc/application.updateTraefikConfig", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/application.readAppMonitoring?appName=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/application.readAppMonitoring?appName=string", {
  method: "GET"
});
```
