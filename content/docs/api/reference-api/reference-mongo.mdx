...
```bash
curl -X POST "http://localhost:3000/api/trpc/mongo.create" \
  -d '{
  "name": "string",
  "appName": "string",
...
```js
fetch("http://localhost:3000/api/trpc/mongo.create", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/mongo.one?mongoId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/mongo.one?mongoId=string", {
  method: "GET"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mongo.start" \
  -d '{
  "mongoId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/mongo.start", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mongo.stop" \
  -d '{
  "mongoId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/mongo.stop", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mongo.saveExternalPort" \
  -d '{
  "mongoId": "string",
  "externalPort": 0
}'
...
```js
fetch("http://localhost:3000/api/trpc/mongo.saveExternalPort", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mongo.deploy" \
  -d '{
  "mongoId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/mongo.deploy", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mongo.changeStatus" \
  -d '{
  "mongoId": "string",
...
```js
fetch("http://localhost:3000/api/trpc/mongo.changeStatus", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mongo.reload" \
  -d '{
  "mongoId": "string",
  "appName": "string"
}'
...
```js
fetch("http://localhost:3000/api/trpc/mongo.reload", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mongo.remove" \
  -d '{
  "mongoId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/mongo.remove", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mongo.saveEnvironment" \
  -d '{
  "mongoId": "string",
  "env": "string"
}'
...
```js
fetch("http://localhost:3000/api/trpc/mongo.saveEnvironment", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mongo.update" \
  -d '{
  "mongoId": "string",
  "name": "string",
  "appName": "string",
...
```js
fetch("http://localhost:3000/api/trpc/mongo.update", {
  method: "POST"
});
```
