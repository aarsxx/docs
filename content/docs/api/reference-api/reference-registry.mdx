...
```bash
curl -X POST "http://localhost:3000/api/trpc/registry.create" \
  -d '{
  "registryName": "string",
  "username": "string",
  "password": "string",
...
```js
fetch("http://localhost:3000/api/trpc/registry.create", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/registry.remove" \
  -d '{
  "registryId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/registry.remove", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/registry.update" \
  -d '{
  "registryId": "string",
  "registryName": "string",
  "imagePrefix": "string",
...
```js
fetch("http://localhost:3000/api/trpc/registry.update", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/registry.all"
```
...
```js
fetch("http://localhost:3000/api/trpc/registry.all", {
  method: "GET"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/registry.one?registryId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/registry.one?registryId=string", {
  method: "GET"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/registry.testRegistry" \
  -d '{
  "registryName": "string",
  "username": "string",
  "password": "string",
...
```js
fetch("http://localhost:3000/api/trpc/registry.testRegistry", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/registry.enableSelfHostedRegistry" \
  -d '{
  "registryUrl": "string",
  "username": "string",
  "password": "string"
...
```js
fetch("http://localhost:3000/api/trpc/registry.enableSelfHostedRegistry", {
  method: "POST"
});
```
