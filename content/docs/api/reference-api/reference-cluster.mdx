...
```bash
curl -X GET "http://localhost:3000/api/trpc/cluster.getNodes"
```
...
```js
fetch("http://localhost:3000/api/trpc/cluster.getNodes", {
  method: "GET"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/cluster.removeWorker" \
  -d '{
  "nodeId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/cluster.removeWorker", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/cluster.addWorker"
```
...
```js
fetch("http://localhost:3000/api/trpc/cluster.addWorker", {
  method: "GET"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/cluster.addManager"
```
...
```js
fetch("http://localhost:3000/api/trpc/cluster.addManager", {
  method: "GET"
});
```
