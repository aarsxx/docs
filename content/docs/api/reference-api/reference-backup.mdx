...
```js
fetch("http://localhost:3000/api/trpc/backup.create", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/backup.one?backupId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/backup.one?backupId=string", {
  method: "GET"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/backup.update" \
  -d '{
  "schedule": "string",
  "enabled": true,
  "prefix": "string",
...
```js
fetch("http://localhost:3000/api/trpc/backup.update", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/backup.remove" \
  -d '{
  "backupId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/backup.remove", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/backup.manualBackupPostgres" \
  -d '{
  "backupId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/backup.manualBackupPostgres", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/backup.manualBackupMySql" \
  -d '{
  "backupId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/backup.manualBackupMySql", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/backup.manualBackupMariadb" \
  -d '{
  "backupId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/backup.manualBackupMariadb", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/backup.manualBackupMongo" \
  -d '{
  "backupId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/backup.manualBackupMongo", {
  method: "POST"
});
```
