...
```bash
curl -X POST "http://localhost:3000/api/trpc/redis.create" \
  -d '{
  "name": "string",
  "appName": "string",
...
```js
fetch("http://localhost:3000/api/trpc/redis.create", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/redis.one?redisId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/redis.one?redisId=string", {
  method: "GET"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/redis.start" \
  -d '{
  "redisId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/redis.start", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/redis.reload" \
  -d '{
  "redisId": "string",
  "appName": "string"
}'
...
```js
fetch("http://localhost:3000/api/trpc/redis.reload", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/redis.stop" \
  -d '{
  "redisId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/redis.stop", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/redis.saveExternalPort" \
  -d '{
  "redisId": "string",
  "externalPort": 0
}'
...
```js
fetch("http://localhost:3000/api/trpc/redis.saveExternalPort", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/redis.deploy" \
  -d '{
  "redisId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/redis.deploy", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/redis.changeStatus" \
  -d '{
  "redisId": "string",
...
```js
fetch("http://localhost:3000/api/trpc/redis.changeStatus", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/redis.remove" \
  -d '{
  "redisId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/redis.remove", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/redis.saveEnvironment" \
  -d '{
  "redisId": "string",
  "env": "string"
}'
...
```js
fetch("http://localhost:3000/api/trpc/redis.saveEnvironment", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/redis.update" \
  -d '{
  "redisId": "string",
  "name": "string",
  "appName": "string",
...
```js
fetch("http://localhost:3000/api/trpc/redis.update", {
  method: "POST"
});
```
