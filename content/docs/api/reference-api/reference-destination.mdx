...
```bash
curl -X POST "http://localhost:3000/api/trpc/destination.create" \
  -d '{
  "name": "string",
  "accessKey": "string",
  "bucket": "string",
...
```js
fetch("http://localhost:3000/api/trpc/destination.create", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/destination.testConnection" \
  -d '{
  "name": "string",
  "accessKey": "string",
  "bucket": "string",
...
```js
fetch("http://localhost:3000/api/trpc/destination.testConnection", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/destination.one?destinationId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/destination.one?destinationId=string", {
  method: "GET"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/destination.all"
```
...
```js
fetch("http://localhost:3000/api/trpc/destination.all", {
  method: "GET"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/destination.remove" \
  -d '{
...
```js
fetch("http://localhost:3000/api/trpc/destination.remove", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/destination.update" \
  -d '{
  "name": "string",
  "accessKey": "string",
  "bucket": "string",
...
```js
fetch("http://localhost:3000/api/trpc/destination.update", {
  method: "POST"
});
```
