...
```js
fetch("http://localhost:3000/api/trpc/project.create", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/project.one?projectId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/project.one?projectId=string", {
  method: "GET"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/project.all"
```
...
```js
fetch("http://localhost:3000/api/trpc/project.all", {
  method: "GET"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/project.remove" \
  -d '{
  "projectId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/project.remove", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/project.update" \
  -d '{
  "name": "string",
  "description": "string",
  "projectId": "string"
...
```js
fetch("http://localhost:3000/api/trpc/project.update", {
  method: "POST"
});
```
