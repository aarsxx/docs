...
```bash
curl -X POST "http://localhost:3000/api/trpc/mariadb.create" \
  -d '{
  "name": "string",
  "appName": "string",
...
```js
fetch("http://localhost:3000/api/trpc/mariadb.create", {
  method: "POST"
});
```
...
```bash
curl -X GET "http://localhost:3000/api/trpc/mariadb.one?mariadbId=string"
```
...
```js
fetch("http://localhost:3000/api/trpc/mariadb.one?mariadbId=string", {
  method: "GET"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mariadb.start" \
  -d '{
  "mariadbId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/mariadb.start", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mariadb.stop" \
  -d '{
  "mariadbId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/mariadb.stop", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mariadb.saveExternalPort" \
  -d '{
  "mariadbId": "string",
  "externalPort": 0
}'
...
```js
fetch("http://localhost:3000/api/trpc/mariadb.saveExternalPort", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mariadb.deploy" \
  -d '{
  "mariadbId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/mariadb.deploy", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mariadb.changeStatus" \
  -d '{
  "mariadbId": "string",
...
```js
fetch("http://localhost:3000/api/trpc/mariadb.changeStatus", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mariadb.remove" \
  -d '{
  "mariadbId": "string"
}'
```
...
```js
fetch("http://localhost:3000/api/trpc/mariadb.remove", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mariadb.saveEnvironment" \
  -d '{
  "mariadbId": "string",
  "env": "string"
}'
...
```js
fetch("http://localhost:3000/api/trpc/mariadb.saveEnvironment", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mariadb.reload" \
  -d '{
  "mariadbId": "string",
  "appName": "string"
}'
...
```js
fetch("http://localhost:3000/api/trpc/mariadb.reload", {
  method: "POST"
});
```
...
```bash
curl -X POST "http://localhost:3000/api/trpc/mariadb.update" \
  -d '{
  "mariadbId": "string",
  "name": "string",
  "appName": "string",
...
```js
fetch("http://localhost:3000/api/trpc/mariadb.update", {
  method: "POST"
});
```
